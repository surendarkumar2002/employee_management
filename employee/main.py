...
# Address
lblAddress = Label(entries_frame, text="Address", font=("Calibri", 14), bg="#535c68", fg="white")
lblAddress.grid(row=4, column=0, padx=10, pady=10, sticky="w")

txtAddress = Text(entries_frame, width=85, height=5, font=("Calibri", 14),)
...
def delete_employee():
    ...
    messagebox.showinfo("Delete","succesfully deleted")
    clear_all()
    display()
...
btnAdd = Button(btn_frame, command=add_employee, text="Add Details", width=12, font=("Calibri", 14, "bold"), bd=0,
                bg="#16a885").grid(row=8, column=0)
btnUpdate = Button(btn_frame, command=update_employee, text="Update Details", width=12, font=("Calibri", 14, "bold"),
                   bd=0,
                   bg="#2988b9").grid(row=8, column=1, padx=10)
btnDelete = Button(btn_frame, command=delete_employee, text="Delete Details", width=12, font=("Calibri", 14, "bold"),
                   bd=0,
                   bg="#c8392b").grid(row=8, column=2, padx=10)
btnClear = Button(btn_frame, command=clear_all, text="Clear Details", width=12, font=("Calibri", 14, "bold"), bd=0,
                  bg="#f39c12").grid(row=8, column=3, padx=10)

# Table Frame
tree_frame = Frame(root, bg="#ecf0f1")
tree_frame.place(x=0, y=439, width=1366, height=500)

style = ttk.Style()
style.configure("mystyle.Treeview", font=('Calibri', 10), rowheight=30)  # modify the font of the heading
